...
RSpec.describe Subject, type: :model do
  ...
  context 'validations' do 
    it 'has a unique name' do
      try_1 = Subject.new(name: "한국어", category_id: @category_1.id, user_id: 1)
    ...
    it 'is invalid without a user' do
      ...
      expect(try_1).to have(1).errors_on(:user)
    end

    it 'is invalid without a category' do
      try_1 = Subject.new(name: "This is s a test", category_id: nil, user_id: 1)
      expect(try_1).to have(1).errors_on(:category)
    end
